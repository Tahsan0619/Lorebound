...
<div class="stats">
    ...
    <div class="card stat"><h3>Compilations</h3><p>{{ $stats['compilations'] }}</p></div>
...
<div class="card">
    ...
    <table>
        <thead><tr><th>Title</th><th>Category</th><th>Input</th><th>Date</th></tr></thead>
        <tbody>
        ...
        @empty
            <tr><td colspan="4">No compilations yet.</td></tr>
        @endforelse
        </tbody>
    </table>
</div>
